...
import { directorNavigation } from '@/lib/director-navigation';
import { RoleSwitcher } from '@/components/ui/RoleSwitcher';
import {
  LayoutDashboard, BarChart3, Users, PoundSterling,
  TrendingUp, ArrowUpDown, Zap,
  PieChart, Layers, Eye, Building2,
  Receipt, Star, Scale,
  Target, FileCheck,
  Wallet, Clock, Crosshair,
  Grid3x3, AlertTriangle, UserPlus,
  BookOpen, Calendar, Newspaper,
  Sparkles, X, Menu,
} from 'lucide-react';
...
export function DirectorSidebar({ activePage, onNavigate, onOpenChat, mobileOpen, onCloseMobile }: DirectorSidebarProps) {
    ...
    <>
      ...
      <aside className={cn(
        ...
        <div className="flex-1 relative">
          {directorNavigation.map(section => (
        ...
        <RoleSwitcher currentUser="James" />
      </aside>
    </>
  );
}

export function DirectorMobileMenuButton({ onClick }: { onClick: () => void }) {
  return (
